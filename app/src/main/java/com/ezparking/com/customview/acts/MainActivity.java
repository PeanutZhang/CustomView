...
import com.ezparking.com.customview.views.MyLinarlayout;
...
public class MainActivity extends AppCompatActivity {
    ...
    ,"贝塞尔曲线写字","effect学习","图像混合","自定义ViewGroup初探","自定义双向滑动RangeBar","recyclerView探索"
    };
    ...
    PatheViewActivity.class,BeizerViewActivity.class, BezierView2Activity.class,WaveViewActivity.class,IndicatorCircleActivity.class,
           PathMeasureActivity.class,MenuControlActivity.class,FootballFieldActivity.class,WorkMangerActivity.class,AnimationL1Activity.class,
            InterpolatorActivity.class, ValueAnimatorActivity.class,WriteBeizerActivity.class,EffectActivity.class,ImgXerActivity.class, LinearCusActivity.class,DoubleRangeBarAct.class
           ,RecylerActivity.class
    };
    @Override
