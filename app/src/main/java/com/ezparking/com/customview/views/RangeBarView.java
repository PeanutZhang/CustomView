        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.RangeBarView_rect_line_checked_color:
                    ...
                    break;
                case R.styleable.RangeBarView_rect_line_height1:
                    rectLineHeight = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,8));
                    break;
                case R.styleable.RangeBarView_circle_radius:
                    circleRadius = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,4));
                    break;
                case R.styleable.RangeBarView_circle_stroke_width1:
                    circleStrokeWidth = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,1));
                    break;
                ...
                case R.styleable.RangeBarView_range_text_size:
                    textSize = typedArray.getDimensionPixelSize(attr, Utils.sp2px(context,13));
                    break;
                ...
                case R.styleable.RangeBarView_view_text_space:
                    spaceDistance = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,8));
                    break;
                case R.styleable.RangeBarView_rect_price_desc_dialog_width:
                    rectDialogWidth = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,80));
                    break;
                ...
                case R.styleable.RangeBarView_rect_price_desc_dialog_corner_radius:
                    rectDialogCornerRadius = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,40));
                    break;
                case R.styleable.RangeBarView_rect_price_desc_text_size:
                    rectDialogTextSize = typedArray.getDimensionPixelSize(attr, Utils.sp2px(context,14));
                    break;
                ...
                case R.styleable.RangeBarView_rect_price_desc_space_to_progress:
                    rectDialogSpaceToProgress = typedArray.getDimensionPixelSize(attr, Utils.dip2px(context,10));
                    break;
            }
        }
        typedArray.recycle();
